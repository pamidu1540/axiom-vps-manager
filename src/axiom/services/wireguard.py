...
class WireGuardService:
    ...
    def add_client(self, client_name: str, client_ip: str = "10.66.66.2/32", server_endpoint: str = "127.0.0.1") -> Dict[str, str]:
        ...
        if os.path.exists(os.path.join(WG_DIR, "server_public.key")):
            with open(os.path.join(WG_DIR, "server_public.key"), "r", encoding="utf-8") as f:
